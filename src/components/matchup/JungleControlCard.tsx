    ...
    <div className="space-y-3">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
        <div className="surface-2 rounded-md px-3 py-2">
          <p className="text-xs font-bold text-brand uppercase tracking-wider mb-1">{t("lane.wardingPriority")}</p>
          <p className="text-xs text-foreground/80">{data.wardingPriority}</p>
        </div>
        <div className="surface-2 rounded-md px-3 py-2">
          <p className="text-xs font-bold text-brand uppercase tracking-wider mb-1">{t("lane.objectiveFocus")}</p>
