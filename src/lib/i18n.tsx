...
const translations = {
  ...
  "nav.soloShort": { pt: "Modo Solo", en: "Solo Mode" },
  ...
  "matchup.back": { pt: "← voltar", en: "← back" },
  "matchup.peak": { pt: "Pico", en: "Peak" },
  "result.tab.summary": { pt: "Resumo", en: "Summary" },
  "result.tab.phases": { pt: "Fases", en: "Phases" },
  "result.tab.build": { pt: "Build", en: "Build" },
  "result.tab.mistakes": { pt: "Erros", en: "Mistakes" },
  "result.askCoach": { pt: "Perguntar algo sobre esse confronto", en: "Ask something about this matchup" },
  "team.identity": { pt: "TIME", en: "TEAM" },
  "team.winCondition": { pt: "Condição de Vitória", en: "Win Condition" },
  "team.threat": { pt: "AMEAÇA", en: "THREAT" },
  ...
  // Footer
  "footer.poweredByAi": { pt: "Powered by IA — planos gerados por inteligência artificial", en: "Powered by AI — plans generated by artificial intelligence" },
  "footer.disclaimer": {
